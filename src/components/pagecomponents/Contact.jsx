...
const Contact = ({ id }) => {
  return (
    <section id={id}>
      <h2 className='text-center bg-black text-white py-8 text-7xl md:text-8xl font-extrabold my-12'>contact .</h2>
      <main className='border-2 container md:w-10/12 mx-auto rounded-lg shadow-md mb-8 p-6 md:p-10 flex flex-col gap-8 md:gap-0 md:flex-row justify-center '>
        {/* Card */}
        <div className='flex flex-col items-start'>
          <h4 className='font-extrabold text-5xl md:text-7xl'>Say Hi</h4>
