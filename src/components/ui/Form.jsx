        ...
        <>
            <form onSubmit={handleSubmit(submitData)} className='w-full mx-auto'>
                <div className='mb-5 flex flex-col gap-2'>
                    <label htmlFor='fullName' className="block text-base font-medium text-gray-900 "> Full Name:</label>
                    <input id='fullName' type="text" {...register('fullName')} placeholder='Your Good Name' className="p-2 rounded-lg" />
                ...
                <div className='mb-5 flex flex-col gap-2'>
                    ...
                    <input id='email' placeholder='Your Email' type="email" {...register('email')}  className="p-2 rounded-lg" />
                    {errors.email && <span className='text-red-600'>{errors.email.message}</span>}
                </div>
                <div className='mb-5 flex flex-col gap-2'>
                    <label htmlFor='subject' className="block text-base font-medium text-gray-900 "> Subject</label>
                    <input id='subject' type="string" {...register('subject')} placeholder='Subject'  className="p-2 rounded-lg" />
                    {errors.subject && <span className='text-red-600'>{errors.subject.message}</span>}
                </div>
                <div className='mb-5 flex flex-col gap-2'>
                    <label htmlFor='message' className="block text-base font-medium text-gray-900 "> Message</label>
                    <textarea id='message' type="text" {...register('message')} placeholder='Your Message'  className="p-2 rounded-lg" />
